...
public class EditProfileActivity extends AppCompatActivity {
    ...
    EditText profileFullName,profileEmail,profilePhone,profileAge, profileBlood;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileAge = findViewById(R.id.agee);
        profileBlood = findViewById(R.id.bloodgroupp);
            ...
            public void onClick(View v) {
                ...
                user.updateEmail(email).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        edited.put("bloodgroup",profileBlood.getText().toString());
        ...
        Log.d(TAG, "onCreate: " + fullName + " " + email + " " + phone + "" + age + "" + bloodgroup + "");
    }
