...
public class ViewEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventsRV.setLayoutManager(new LinearLayoutManager(ViewEvent.this));

        // on below line passing our array lost to our adapter class.
        eventRVAdapter= new EventRVAdapter(eventArrayList, ViewEvent.this);
        ...
        db.collection("Event").get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        if (!queryDocumentSnapshots.isEmpty()) {
                            ...
                            Toast.makeText(ViewEvent.this, "No data found in Database", Toast.LENGTH_SHORT).show();
                        }
                    }
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(ViewEvent.this, "Fail to get the data.", Toast.LENGTH_SHORT).show();
            }
        });
    }
   ...
   ArrayList<Event> search = new ArrayList<>();
        ...
        if (search.isEmpty()) {
            ...
            Toast.makeText(ViewEvent.this, "No Data Found..", Toast.LENGTH_SHORT).show();
        } else {
