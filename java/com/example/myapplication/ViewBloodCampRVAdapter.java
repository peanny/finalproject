...
public class ViewBloodCampRVAdapter extends RecyclerView.Adapter<ViewBloodCampRVAdapter.ViewHolder> {
    private ArrayList<Event> eventArrayList;
    private Context context3;

    // constructor
    public ViewBloodCampRVAdapter(ArrayList<Event>eventArrayList, Context context3) {
    ...
    @NonNull
    @Override
    public ViewBloodCampRVAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // on below line we are inflating our layout
        // file for our recycler view items.
        return new ViewBloodCampRVAdapter.ViewHolder(LayoutInflater.from(context3).inflate(R.layout.activity_event_rv_item, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull ViewBloodCampRVAdapter.ViewHolder holder, int position) {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(context3, ViewBloodViewDetails.class);
